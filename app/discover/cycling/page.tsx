    ...
    return (
        <>
            ...
            <div className="w-[90vw] md:w-[80vw] mx-auto items-center justify-center px-4 md:px-8 pt-20 pb-24">
                <p className="text-sm mb-20"><span className="font-semibold">Home / Scopri il territorio / </span>Cicloturismo</p>
                <div
            ...
            <div
                ...
                <div className="flex flex-col gap-2 w-full md:w-2/4">
                    ...
                    <p className="w-full mt-2 pl-1 whitespace-pre-line">Il territorio cremasco, con Crema come cuore, è
                        ideale per il cicloturismo. L'itinerario più noto segue l'alzaia del Canale Vacchelli, una via
                        ...
                        Cremona e il suo territorio offrono un'esperienza cicloturistica tutta da godere. In città, si
                        pedala tra il Torrazzo e il Museo del Violino. La rete di piste ciclabili e strade minori segue
                        gli argini del Po e dell’Adda, interseca riserve naturali e conduce a borghi ricchi di storia
                        ...
                        affascinanti e siti di archeologia industriale. Diversi edifici storici come Villa Medici del
            ...
            <div className="h-[500px] mb-4 rounded-xl border-green-500 border bg-green-100 flex items-center justify-center">
                Komoot Map #1
            </div>
            <div className="flex gap-4 w-full">
                <div className="w-[33%] h-[200px] rounded-xl border-green-500 border bg-green-100 flex items-center justify-center">
                    Komoot Map #2
                </div>
                <div className="w-[33%] h-[200px] rounded-xl border-green-500 border bg-green-100 flex items-center justify-center">
                    Komoot Map #3
