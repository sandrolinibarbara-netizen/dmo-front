        ...
        <div className="mt-5 flex md:flex-row flex-col gap-4 w-full">
            {info.download_1[0] &&
                <div
                    ...
                    <a href={info.download_1[0].download ? process.env.NEXT_PUBLIC_BASE_URL + info.download_1[0].download.url : info.download_1[0].link}
            ...
            {info.download_2[0] &&
                <div
                    ...
                    <a href={info.download_2[0].download ? process.env.NEXT_PUBLIC_BASE_URL + info.download_2[0].download.url : info.download_2[0].link}
            ...
            {info.download_3[0] &&
                <div
                    ...
                    <a href={info.download_3[0].download ? process.env.NEXT_PUBLIC_BASE_URL + info.download_3[0].download.url : info.download_3[0].link}
