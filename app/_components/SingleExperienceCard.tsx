...
export default function SingleExperienceCard({el} : {el:Experience}) {
    return(
        <div className="h-[348px] w-[27.5%] border border-orange-500 rounded-xl text-black bg-[#F0F8FF]">
            ...
            <div className="px-4 pt-4 pb-2">
                <h4 className="font-bold h-[32px]">{el.titolo}</h4>
                <p className="h-[104px]">{el.descrizione}</p>
